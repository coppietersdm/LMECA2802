...
def user_ExtForces(PxF, RxF, VxF, OMxF, AxF, OMPxF, mbs_data, tsim, ixF):
    ...
    if ixF == mbs_data.extforce_id["ExtForce_0"]:
        ...
        P_Y6 = mbs_data.S6_P[2]
        P_Z6 = mbs_data.S6_P[3]
        V_Y6 = mbs_data.S6_V[2]
        V_Z6 = mbs_data.S6_V[3]

        Fy = -((PxF[2]-P_Y6)*Kconn+Dconn*(VxF[2]-V_Y6))
        Fz = -((PxF[3]-P_Z6)*Kconn+Dconn*(VxF[3]-V_Z6))
        ...
        P_Y7 = mbs_data.S7_P[2]
        P_Z7 = mbs_data.S7_P[3]
        V_Y7 = mbs_data.S7_V[2]
        V_Z7 = mbs_data.S7_V[3]

        Fy = -((PxF[2]-P_Y7)*Kconn+Dconn*(VxF[2]-V_Y7))
        Fz = -((PxF[3]-P_Z7)*Kconn+Dconn*(VxF[3]-V_Z7))

    elif ixF == mbs_data.extforce_id["ExtForce_6"]:
        P_Y3 = mbs_data.S3_P[2]
        P_Z3 = mbs_data.S3_P[3]
        V_Y3 = mbs_data.S3_V[2]
        V_Z3 = mbs_data.S3_V[3]
    ...
    elif ixF == mbs_data.extforce_id["ExtForce_7"]:
        P_Y5 = mbs_data.S5_P[2]
        P_Z5 = mbs_data.S5_P[3]
        V_Y5 = mbs_data.S5_V[2]
        V_Z5 = mbs_data.S5_V[3]
