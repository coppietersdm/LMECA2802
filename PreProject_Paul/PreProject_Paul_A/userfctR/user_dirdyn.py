...
def user_dirdyn_init(mbs_data, mbs_dirdyn):
    ...
    mbs_data.S6 = Robotran.MbsSensor(mbs_data)
    mbs_data.S6_P = [0,0,0,0]
    mbs_data.S6_V = [0,0,0,0]

    mbs_data.S7 = Robotran.MbsSensor(mbs_data)
    mbs_data.S7_P = [0,0,0,0]
    mbs_data.S7_V = [0,0,0,0]
...
def user_dirdyn_loop(mbs_data, mbs_dirdyn):
    ...
    mbs_data.S6.comp_s_sensor(mbs_data.extforce_id["ExtForce_6"])
    mbs_data.S6_P = [0,mbs_data.S6.P[1],mbs_data.S6.P[2],mbs_data.S6.P[3]]
    mbs_data.S6_V = [0,mbs_data.S6.V[1],mbs_data.S6.V[2],mbs_data.S6.V[3]]

    mbs_data.S7.comp_s_sensor(mbs_data.extforce_id["ExtForce_7"])
    mbs_data.S7_P = [0,mbs_data.S7.P[1],mbs_data.S7.P[2],mbs_data.S7.P[3]]
    mbs_data.S7_V = [0,mbs_data.S7.V[1],mbs_data.S7.V[2],mbs_data.S7.V[3]]
...
def user_dirdyn_finish(mbs_data, mbs_dirdyn):
    ...
    plt.title("Roof lateral position")
    ...
    plt.title("Wall Horizontal Force")
