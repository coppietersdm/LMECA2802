...
def user_JointForces(mbs_data, tsim):
    ...
    circular_spring_id = [mbs_data.joint_id["Joint_3"],mbs_data.joint_id["Joint_4"],mbs_data.joint_id["Joint_5"],mbs_data.joint_id["Joint_6"],mbs_data.joint_id["Joint_13"],mbs_data.joint_id["Joint_14"],mbs_data.joint_id["Joint_15"],mbs_data.joint_id["Joint_16"],mbs_data.joint_id["Joint_17"],mbs_data.joint_id["Joint_18"],mbs_data.joint_id["Joint_19"],mbs_data.joint_id["Joint_20"]]
    Kflex = 8.5e6
    Dflex = 1.0e4
